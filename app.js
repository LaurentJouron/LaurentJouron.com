...
.pauseFor(1800)
.changeDelay(22)
.typeString('Welcome I\'m Laurent Jouron')
.pauseFor(300)
.typeString('<strong>, Application developper </strong>')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #F6D049;"><strong> Python </strong></span>')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #006EBF;"><strong> SQL </strong></span>')
.pauseFor(1000)
.deleteChars(6)
.typeString('<span style="color: #D25836;"><strong> HTML </span><span style="color: #254BDD;">- CSS </strong></span>')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #5C2B3D;"><strong> Windev </strong></span>')
.start()
