...
.pauseFor(1800)
.changeDelay(19)
.typeString('<span style="color: #B9B9B9;">Welcome on my website! </span>')
.pauseFor(800)
.deleteChars(24)
.typeString('<span style="color: #B9B9B9;">I use : </span><strong><span style="color: #366C9C;"> Python</span></strong>')
.pauseFor(1000)
.deleteChars(8)
...
.pauseFor(1000)
.deleteChars(3)
.typeString('<strong><span style="color: #D25836;"> HTML</span></strong>')
.pauseFor(1000)
.deleteChars(4)
...
.pauseFor(1000)
.deleteChars(37)
.typeString('<span style="color: #B9B9B9;"> I\'m Laurent Jouron, </span>')
.pauseFor(1000)
