...
.pauseFor(1800)
.changeDelay(19)
.typeString('<span style="color: #FEEA9A;">Je suis passionné par le développement</span>')
.pauseFor(1600)
.deleteChars(38)
.typeString('<span style="color: #FEEA9A;">Je travaille avec </span><strong><span style="color: #366C9C;"> Python</span></strong>')
.pauseFor(1000)
.deleteChars(6)
.typeString('<strong><span style="color: #44B78B;"> Django</span></strong>')
.pauseFor(1000)
.deleteChars(6)
.typeString('<strong><span style="color: #006EBF;"> SQL</span></strong>')
.pauseFor(1000)
.deleteChars(3)
.typeString('<strong><span style="color: #802D2D;"> Django RESTFramework</span></strong>')
.pauseFor(1000)
.deleteChars(46)
.typeString('<span style="color: #FEEA9A;"> Je suis Laurent Jouron, </span>')
.pauseFor(1000)
.typeString('<strong><span style="color: #EF9700;">DEVELOPPEUR D\'APPLICATIONS</span></strong>')
.start()
